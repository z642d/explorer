var mongoose = require('mongoose')
  ...
  , freiexchange = require('./markets/freiexchange')
...
function get_market_data(market, cb) {
  switch(market) {
    ...
    case 'freiexchange':
      freiexchange.get_data(settings.markets.coin.toLowerCase(), settings.markets.exchange.toLowerCase(), function(err, obj){
        return cb(err, obj);
      });
      break;
    default:
